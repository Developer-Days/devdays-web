...
const Footer = () => {
  return <div className="top-0 w-screen px-4 py-7 justify-center bg-[#f5f5f5] flex">
  <div className="w-full flex container justify-center">
    <div className=" items-center flex-col gap-2">
      <div className="text-lg font-semibold text-gray-800 font-inter italic">
        keep yourself updated
      </div>
      <div className="flex text-gray-700 delay-300 text-xl gap-5">
        <a
          target={"_blank"}
          rel={"noreferrer"}
