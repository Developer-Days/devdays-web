...
const Main = () => {
  return (
    <div className="relative text-center max-w-lg mx-auto lg:max-w-none lg:text-left">
      ...
      The overpowering series of Developer Days is coming back soon! New Tracks and New Challenges, along with a pinch of surprise for the whole developer community. 
      </h5>
      <div className="mt-10  flex flex-col item-start gap-5">
        ...
        <a
          target={"_blank"}
          rel={"noreferrer"}
          href="http://volunteers.developerdays.tech/"
        >
          <button className="px-4 hover:brightness-105 rounded-xl py-2 font-League-Spartan text-2xl text-white bg-[#E94643]">
            Join Now
          </button>
        </a>
      </div>
